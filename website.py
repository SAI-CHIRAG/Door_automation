...
img = Image.open(r"Vit.jpeg")

with body:
    st.title('Update your info in Our server')
    st.write('##')
    #st.write('##')
    ...
    if submitted:
        ...
        os.remove(r'emp_face_encodings.yml')
        os.remove(r'emp_face_names.yml')
        os.remove(r'emp_phno.yml')
        os.remove(r'emp_id.yml')
